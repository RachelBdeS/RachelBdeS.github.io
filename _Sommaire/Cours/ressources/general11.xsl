...
<!-- Version 1.11 du 31/05/2011
	- Ajout de x-webkit-speech au moteur de recherche
-->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"                    xmlns:date="http://exslt.org/dates-and-times" extension-element-prefixes="date">
	...
	<xsl:template name="gen_entete">
		...
		<div id="entete">
			...
			<xsl:choose>
				<xsl:when test="$destination='siteweb'"><form action="http://www.google.com/search" id="recherche"><p><label for="formrecherche">Chercher dans le cours&#160;:</label>&#160;<input name="q" type="text" size="10" accesskey="4" tabindex="4" id="formrecherche" x-webkit-speech="x-webkit-speech" /><input type="hidden" name="q" value="site:www.gchagnon.fr/cours/{document(concat('../',$location,'/','cours.xml'))/cours/@typecourssiteweb}/"/>&#160;<input type="image" src="images/recherche3.png" alt="Chercher" value="Chercher"/></p></form></xsl:when>
				<xsl:when test="$destination='coursenligne'"><form action="http://www.google.com/search" id="recherche"><p><label for="formrecherche">Chercher dans le cours&#160;:</label>&#160;<input name="q" type="text" size="10" accesskey="4" tabindex="4" id="formrecherche" x-webkit-speech="x-webkit-speech" /><input type="hidden" name="q" value="site:www.licence.elec.upmc.fr/S_tec/coursEnLigne/{document(concat('../',$location,'/','cours.xml'))/cours/@typecoursenligne}/"/>&#160;<input type="image" src="images/recherche_vert2.png" alt="Chercher" value="Chercher"/></p></form></xsl:when>
				<xsl:otherwise><form action="http://www.google.com/search" id="recherche"><p><label for="formrecherche">Chercher dans le cours&#160;:</label>&#160;<input name="q" type="text" size="10" accesskey="4" tabindex="4" id="formrecherche" x-webkit-speech="x-webkit-speech" /><input type="hidden" name="q" value="site:www.gchagnon.fr/cours/{document(concat('../',$location,'/','cours.xml'))/cours/@typecourssiteweb}/"/>&#160;<input type="image" src="images/recherche3.png" alt="Chercher" value="Chercher"/></p></form></xsl:otherwise>
			</xsl:choose>
		</div>
	</xsl:template>
